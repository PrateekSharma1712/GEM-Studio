...
public class AppConstants {
	...
	public static final String CUSTOM_PREFERENCE = "gem_gcm_1";
	...
	public final static int REQUEST_CODE_FROM_GALLERY_KITKAT = 02;
    public final static int REQUEST_CODE_CLICK_IMAGE = 03;
	...
	public static final String URL_API = "http://www.preetimodi.com/gem_api_local/gem.php";
	
	public static final String URL_IMAGES = "http://www.preetimodi.com/gem_api_local/images/";
	
	public static final String URL_UPLOADTOSERVER = "http://www.preetimodi.com/gem_api_local/uploadtoserver.php";
    ...
    public static final String SERVER_URL = "http://www.preetimodi.com/gem_api_local/gcm_server_php/register.php";
     ...
     *
     * @param context application's baseActivity.
    ...
    public static final int ACTION_REQUEST_EMAIL = 3;
