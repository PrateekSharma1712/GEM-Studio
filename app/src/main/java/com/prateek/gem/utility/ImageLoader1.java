...
import com.prateek.gem.BuildConfig;
import com.prateek.gem.utility.ImageCache;
 ...
 */
public abstract class ImageLoader1 {
    ...
    protected ImageLoader1(Context context, int imageSize) {
     ...
     * {@link ImageLoader1#processBitmap(Object)} to define the processing logic). If the image is
     ...
     *            {@link ImageLoader1#loadImage(Object, ImageView)}
